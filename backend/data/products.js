const products = [
  {
    name: 'Bateau de pêche tout soudé de 13 pieds',
    brand: 'Haiyu',
    ...
    options: [
      { name: 'Matériau de coque', value: 'En aluminium' },
      { name: 'Type de carburant', value: 'Essence' },
      { name: 'Longueur (m)', value: '< 4m' },
      { name: 'Ébauche', value: '0.30m' },
      { name: 'Marque', value: 'Haiyu' },
      { name: 'Longueur', value: '3.80m' },
      { name: 'Largeur', value: '1.50m' },
      { name: 'Profondeur', value: '0.54m' },
      { name: 'Épaisseur', value: '2.0mm' },
      { name: 'Poids', value: '96kg' },
      { name: 'Capacité', value: '4p' },
      { name: 'Puissance', value: '15hp-30hp' },
    ],
    keywords: ['bateau', 'pêche', 'aluminium', 'Haiyu'],
  },

  {
    ...
    options: [
      { name: "Taille de l'écran", value: '50′′' },
      {
        name: 'Application',
        value:
          'Intérieur, Ordinateur, Publicité, Extérieur, Conception graphique, Karaoké TV',
      },
      { name: "Format d'image", value: '16:9' },
      {
        name: 'Caractéristique',
        value:
          'Affichage rétroéclairé LED, Avec télécommande, Supporte la fonction TV',
      },
      { name: 'Résolution optimale', value: '3840x2160' },
      { name: 'Type', value: 'TFT' },
    ],
  },
  {
  ...
  {
    name:
      'Transmission de haute qualité pour ISUZU D-MAX - Manuel 4X4 DMAX 3.0',
    brand: 'R&E',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
  ...
  {
    name: "Ensemble générateur d'alternateur pour moteur diesel ISUZU",
    brand: 'PASOU',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
  ...
  {
    name:
      'pièces détachées automobiles aftermarket pour ISUZU DMAX MUX 2.5 3.0 - 4JK1, 4JJ1, 4JB1, 4JH1 - D-MAX MU-X',
    brand: 'PASOU',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
  ...
  {
    name:
      'Rhv4 Turbo Core pour DMAX 3.0 avec Turbocompresseur - Compatible avec Isuzu 8981320703 et 8974350071',
    brand: 'AFAN',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
  ...
  {
    name: 'Chargeuse sur Roues - Chargeurs Compacts de 1.8 ',
    brand: ' Cummings',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 0,
    description:
  ...
  {
    name:
      'Bateau de Pêche en Fibre de Verre de 27 pieds avec Coque en V, Livré avec Moteur Hors-bord.',
    brand: 'Kinocean',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
    ...
    subCategory: '65cf60efc6daa9f0968b7ab2',
    url:
      'https://www.alibaba.com/product-detail/subject_1600733057937.html?from=share&ckvia=share_151fefb49c424ab69292199aaa55b16e',
  },
  {
    name: 'Moteur hors-bord marin essence de 40 chevaux',
    brand: ' GZZH',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
  ...
  {
    name: "Volkswagen GTI Voitures d'Occasion",
    brand: 'Volkswagen',
    category: '65cf60e4c6daa9f0968b7aac',
    countInStock: 5,
    description:
