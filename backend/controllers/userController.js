...
const forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  const message = `
  Vous recevez cet e-mail car vous (ou une autre personne) avez demandé la réinitialisation d'un mot de passe sur Caledonie Moins Cher. Veuillez effectuer une requête à : \n\n ${resetUrl}`
